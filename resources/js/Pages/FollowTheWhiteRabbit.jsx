            ...
            <div className='px-3 md:px-12 mx-3 md:mx-12 mb-12'>
                <div>
                    ...
                    <Paragraph 
                        ...
                        Which led me to a third assumption, that the hardest phase may be more than 3 words and will likely include at least one word which contains a diacritic mark or apostrophy."
                    />
                    <SubTitle title="Solution" />
                    <Paragraph 
                        text="The first thing I wanted to do was reduce the word count from nearly 100,000 words into something more manageable.  
                    ...
                    <div>
                        ...
                        <Paragraph 
                            text="At this point the wordlist count was down to about 1650 words and ready to be looped over.  
                        ...
                        <Paragraph 
                            text="Once I had a three word phrase it was time to turn it into an MD5 hash and compare it. 
                        ...
                        />
                        <Paragraph 
                            text="The code below isn't the whole class as I wanted to keep the code examples down to enhance the narrative.  
                        ...
                        <SubTitle title="The Hardest Difficulty" />
                        <Paragraph 
                            text="After failing to find the hardest hash with the initial approach I reintroduced the words which were apostrophised and/or included diacritic marks. This added another 1000+ words into the loop and a few more considerations when comparing the word to the anagram.
                        ...
                        />
                        <Paragraph 
                            text="On the topic of performance, I believe saving the wordlist to a database would have had a positive impact as it reduces how much is saved to memory during the process but for some reason decided this was outside the scope of the challenge.  
                        ...
                        <Paragraph 
                            text="Finally I allowed a fourth word into the phrase and ran the code again.  
