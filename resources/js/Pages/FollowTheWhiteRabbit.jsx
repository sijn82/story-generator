...
export default function FollowTheWhiteRabbit()
{
    return (
        <div className='max-w-screen-lg mx-auto'>
            <div className='text-center font-bold text-zinc-500 text-3xl my-6'> Follow The White Rabbit </div>
            <div className='px-3 md:px-12 mx-3 md:mx-12'>
                <div>
                    ...
                    <div>
                        ...
                        <div className='font-bold text-2xl text-zinc-500 my-6'> The Hardest Difficulty </div>
                        <div className='text-zinc-700 mb-3 max-w-prose md:text-lg mx-auto'>
