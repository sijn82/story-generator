        ...
        <div className='max-w-screen-lg mx-auto'>
            ...
            <div className='px-3 md:px-12 mx-3 md:mx-12'>
                <div>
                    ...
                    <div className="text-zinc-600 my-3">
                        <div className="font-bold text-base text-zinc-500 my-3">
                            AI Prompts
                        </div>
                        <div className="text-zinc-600 my-3">
                    ...
                    <div className='font-bold text-lg text-zinc-500 my-3'> Initial Conclusions </div>
                    <div className="text-zinc-600 my-3">
                        ...
                        Story generation was much more reliable than character generation but I didn't get a chance to work out why before having to move away from OpenAI and switching to a new model/provider.  I opted for HuggingFace as the new provider and Mistral-Small-Instruct-2409 for the model on a free tier.
                    </div>
                    <div className="text-zinc-600 my-3">
                    ...
                    <div className='font-bold text-lg text-zinc-500 my-3'> Next Steps </div>
                    <div className="text-zinc-600 mt-3 mb-12">
