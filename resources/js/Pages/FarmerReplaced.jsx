...
export default function FarmerReplaced() {
    ...
    return (
        <div className='w-full'>
            <div className='text-center font-bold text-black/50 text-lg my-6'> The Farmer Was Replaced </div>
            <div className='px-12 text-xs'>
                <div>
                    <div className='text-lg text-black/50 my-3'> Task </div>
                    ...
                    <div className='text-lg text-black/50 my-3'> Solution </div>
                </div>
                <div>
                    <div className='py-3'>
                ...
                <div>
                    <div className='text-lg text-black/50 my-3'> Demo </div>
                    <div className='flex justify-center pb-6'>
                        <video controls width="50%" src="http://d1fftu7568zsov.cloudfront.net/the_farmer_was_replaced_maze_run.mp4"></video>
                    </div>
                </div>
                <div>
                    <div className='text-lg text-black/50 my-3'> Final notes </div>
                    <div className='text-sm md:text-base mb-3'>
