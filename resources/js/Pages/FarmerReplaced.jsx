...
export default function FarmerReplaced() {
    ...
    return (
        <div className='max-w-screen-lg mx-auto'>
            <div className='text-center font-bold text-zinc-500 text-3xl my-6'> The Farmer Was Replaced </div>
            <div className='px-3 md:px-12 mx-3 md:mx-12'>
                <div>
                    <div className='font-bold text-2xl text-zinc-500 my-6'> Task </div>
                    <div className='text-zinc-600 mb-3 max-w-prose md:text-lg mx-auto'>
                ...
                <div>
                    <div className='font-bold text-2xl text-zinc-500 my-6'> Demo </div>
                ...
                <div>
                    ...
                    <div className='text-zinc-600 mb-12 max-w-prose md:text-lg mx-auto'>
